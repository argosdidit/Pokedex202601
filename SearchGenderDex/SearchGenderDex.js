      ...
      if(flag){
        ...
        switch(bright_or_dark)
        {
          case "bright":
            htmlPageStyle =
            `
            <link rel="stylesheet" href="SearchGenderBright.css">
            <link rel="icon" href="SearchGenderBright.png">
            `;
            break;
          case "dark":
            htmlPageStyle =
            `
            <link rel="stylesheet" href="SearchGenderDark.css">
            <link rel="icon" href="SearchGenderDark.png">
            `;
            break;
          default:
            htmlPageStyle =
