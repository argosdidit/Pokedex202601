  ...
  func = {
    ...
    makeDecisionButton: function(){
      if(flag){
        ...
        <button id="BtnReload">
        <a id="decisionButton" href="../SearchGenderDex/SearchGenderDex.html">
    ...
    updateURL: async function(){
      if(flag){
        let newURL = `../SearchGenderDex/SearchGenderDex.html`;
    ...
    judgeStyles: function(){
      if(flag){
        ...
        {
          case 'BRIGHT':
            htmlPageStyle = `<link rel="stylesheet" href="SearchGenderDexBright.css">`;
            favicon.href = "SearchGenderDexBright.png";
            break;
          case 'DARK':
            htmlPageStyle = `<link rel="stylesheet" href="SearchGenderDexDark.css">`;
            favicon.href = "SearchGenderDexDark.png";
            break;
          default:
            htmlPageStyle = `<link rel="stylesheet" href="SearchGenderDexBright.css">`;
            favicon.href = "SearchGenderDexBright.png";
