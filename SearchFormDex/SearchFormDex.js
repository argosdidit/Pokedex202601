const PokeSearch = (() => {
  ...
  func = {
    ...
    updateURL: async function(){
      if(flag){
        let newURL = `../SearchFormDex/SearchFormDex.html`;
    ...
    toggleForm(btn) {
      ...
      if (selectedForms.has(key))
      {
        selectedForms.delete(key);
        btn.classList.remove('selected');
      }
      else
      {
        selectedForms.add(key);
    ...
    judgeStyles: function(){
      if(flag){
        ...
        {
          case 'BRIGHT':
            htmlPageStyle = `<link rel="stylesheet" href="SearchFormDexBright.css">`;
            favicon.href = "SearchFormDexBright.png";
            break;
          case 'DARK':
            htmlPageStyle = `<link rel="stylesheet" href="SearchFormDexDark.css">`;
            favicon.href = "SearchFormDexDark.png";
            break;
          default:
            htmlPageStyle = `<link rel="stylesheet" href="SearchFormDexBright.css">`;
            favicon.href = "SearchFormDexBright.png";
