      ...
      if(flag){
        ...
        switch(bright_or_dark)
        {
          case "bright":
            htmlPageStyle =
            `
            <link rel="stylesheet" href="SearchTypeBright.css">
            <link rel="icon" href="SearchTypeBright.png">
            `;
            break;
          case "dark":
            htmlPageStyle =
            `
            <link rel="stylesheet" href="SearchTypeDark.css">
            <link rel="icon" href="SearchTypeDark.png">
            `;
            break;
          default:
            htmlPageStyle =
